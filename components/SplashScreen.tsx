  ...
  return (
    <div
      style={{
        ...
        background: 'radial-gradient(ellipse at 50% 40%, #FFF0F5 0%, #ffffff 70%)',
        opacity: fading ? 0 : 1,
    ...
    >
      <div
        style={{
          ...
          height: 200,
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(255,46,122,0.08) 0%, transparent 70%)',
      ...
      >
        <div
          style={{
            ...
            justifyContent: 'center',
            borderRadius: 24,
            backgroundColor: '#FF2E7A',
            fontSize: 40,
            boxShadow:
              step >= 1 ? '0 8px 32px rgba(255,46,122,0.3)' : '0 0 0 rgba(255,46,122,0)',
